(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=`lilsnips`,t=3;function n(){return new Promise((n,r)=>{let i=indexedDB.open(e,t);i.onupgradeneeded=e=>{let t=e.target.result;t.objectStoreNames.contains(`folders`)||t.createObjectStore(`folders`,{keyPath:`id`}),t.objectStoreNames.contains(`snips`)||t.createObjectStore(`snips`,{keyPath:`id`}).createIndex(`folderId`,`folderId`,{unique:!1}),t.objectStoreNames.contains(`settings`)||t.createObjectStore(`settings`,{keyPath:`key`}),t.objectStoreNames.contains(`images`)||t.createObjectStore(`images`,{keyPath:`id`}).createIndex(`folderId`,`folderId`,{unique:!1})},i.onsuccess=()=>n(i.result),i.onerror=()=>r(i.error)})}async function r(e,t,r){let i=await n();return new Promise((n,a)=>{let o=r(i.transaction(e,t).objectStore(e));o.onsuccess=()=>n(o.result),o.onerror=()=>a(o.error)})}var i=(e,t)=>r(e,`readonly`,e=>e.get(t)),a=e=>r(e,`readonly`,e=>e.getAll()),o=(e,t)=>r(e,`readwrite`,e=>e.put(t)),s=(e,t)=>r(e,`readwrite`,e=>e.delete(t)),c={theme:`default`,textScale:100},l={useLLM:!0,useSerpAPI:!1,wantsR1Response:!0,wantsJournalEntry:!1,checkboxesEnabled:!1};async function u(){let e=await i(`settings`,`appSettings`);return e?{...c,...e.value}:{...c}}async function d(e){await o(`settings`,{key:`appSettings`,value:e})}var f=[{id:`default`,name:`R1 Orange`,bg:`#000`,fg:`#fff`,accent:`#FE5F00`,card:`#1a1a1a`,border:`#333`},{id:`midnight`,name:`Midnight Blue`,bg:`#0a0e1a`,fg:`#e0e6f0`,accent:`#4a90d9`,card:`#131a2e`,border:`#253352`},{id:`cyberpunk`,name:`Cyberpunk`,bg:`#0d0015`,fg:`#e0d0ff`,accent:`#ff00ff`,card:`#1a0030`,border:`#4a0066`},{id:`forest`,name:`Forest`,bg:`#071207`,fg:`#d0f0d0`,accent:`#2ecc71`,card:`#0f1f0f`,border:`#1e3e1e`},{id:`sunset`,name:`Sunset`,bg:`#1a0a05`,fg:`#ffe0c0`,accent:`#ff6b35`,card:`#2a1208`,border:`#4a2010`},{id:`arctic`,name:`Arctic`,bg:`#f0f4f8`,fg:`#1a2a3a`,accent:`#0077b6`,card:`#fff`,border:`#c0d0e0`},{id:`cherry`,name:`Cherry`,bg:`#150008`,fg:`#ffd0dd`,accent:`#e63956`,card:`#250010`,border:`#450020`},{id:`gold`,name:`Gold Rush`,bg:`#0f0d05`,fg:`#f0e8d0`,accent:`#d4a017`,card:`#1a1808`,border:`#3a3210`},{id:`terminal`,name:`Terminal`,bg:`#000`,fg:`#0f0`,accent:`#0f0`,card:`#0a0a0a`,border:`#030`},{id:`lavender`,name:`Lavender`,bg:`#0e0a14`,fg:`#e8ddf0`,accent:`#9b59b6`,card:`#1a1224`,border:`#2e1e40`}];function p(e){let t=f.find(t=>t.id===e)||f[0],n=document.documentElement.style;n.setProperty(`--bg`,t.bg),n.setProperty(`--fg`,t.fg),n.setProperty(`--accent`,t.accent),n.setProperty(`--card`,t.card),n.setProperty(`--card-border`,t.border)}function m(e){document.documentElement.style.setProperty(`--text-scale`,(e/100).toString())}var h={screen:`home`,folders:[],snips:[],images:[],currentFolderId:null,settings:{...c},editTarget:null,isRecording:!1,statusMsg:``,lastAgentResponse:null,cameraActive:!1,cameraPreviewData:null,cameraStream:null},g=null;function _(){return Date.now().toString(36)+Math.random().toString(36).slice(2,8)}function v(e){return document.querySelector(e)}function y(e){let t=document.createElement(`div`);return t.textContent=e||``,t.innerHTML}function b(e,t){return e?e.length>t?e.slice(0,t)+`…`:e:``}function x(e){return e<10?`0`+e:``+e}function S(e){return e&&e.agentSettings?{...l,...e.agentSettings}:{...l}}function C(){return S(h.folders.find(e=>e.id===h.currentFolderId))}var w=null;function T(){if(h.cameraActive=!0,h.cameraPreviewData=null,P(),!navigator.mediaDevices||!navigator.mediaDevices.getUserMedia){Q(`Camera not supported`),D();return}navigator.mediaDevices.getUserMedia({video:{facingMode:{ideal:`environment`},width:{ideal:640},height:{ideal:480}},audio:!1}).then(e=>{w=e,h.cameraStream=e,Q(`Camera active`),P()}).catch(e=>{console.error(`Camera error:`,e),Q(`Camera denied`),D()})}function E(){if(!h.cameraActive||!w)return;let e=document.querySelector(`#cameraVideo`);if(!e||e.readyState<2){Q(`Not ready`);return}let t=e.videoWidth,n=e.videoHeight;if(!t||!n){Q(`No video frame`);return}let r=document.createElement(`canvas`);r.width=t,r.height=n,r.getContext(`2d`).drawImage(e,0,0,t,n);let i=r.toDataURL(`image/jpeg`,.85);h.cameraActive=!1,w&&=(w.getTracks().forEach(e=>e.stop()),null),h.cameraStream=null,O(i)}function D(){w&&=(w.getTracks().forEach(e=>e.stop()),null),h.cameraStream=null,h.cameraActive=!1,h.cameraPreviewData=null,P()}async function O(e,t){let n={id:_(),name:`Photo `+new Date().toLocaleTimeString(),dataUrl:e,folderId:h.currentFolderId||null,caption:t||``,createdAt:Date.now()};h.images.push(n),await o(`images`,n),Q(`Photo saved`)}var k=0,A=null,j=400;function M(){let e=Date.now(),t=e-k;if(k=e,A&&=(clearTimeout(A),null),t<j){k=0,h.cameraActive?D():T();return}A=setTimeout(()=>{A=null,h.cameraActive?E():N()},j)}function N(){h.screen===`editModal`?B():h.screen===`folderSettings`?(h.screen=`folder`,P()):h.screen===`settings`||h.screen===`themeSelect`?(h.screen=`home`,P()):h.screen===`folder`&&(h.screen=`home`,h.currentFolderId=null,P())}window.addEventListener(`sideClick`,M),document.addEventListener(`keydown`,e=>{e.code===`Space`&&!g&&(e.preventDefault(),M())}),window.addEventListener(`longPressStart`,()=>{h.cameraActive||(h.isRecording=!0,P(),typeof CreationVoiceHandler<`u`&&CreationVoiceHandler.postMessage(`start`))}),window.addEventListener(`longPressEnd`,()=>{h.cameraActive||(h.isRecording=!1,P(),typeof CreationVoiceHandler<`u`&&CreationVoiceHandler.postMessage(`stop`))}),window.onPluginMessage=async function(e){if(e.type===`sttEnded`&&e.transcript){let t=e.transcript.trim();if(!t)return;if(g){let e=g,n=e.selectionStart,r=e.selectionEnd;e.value=e.value.substring(0,n)+t+e.value.substring(r),e.selectionStart=e.selectionEnd=n+t.length,e.focus();return}let n={id:_(),text:t,folderId:h.currentFolderId||null,checked:!1,createdAt:Date.now(),updatedAt:Date.now()};h.snips.push(n),await o(`snips`,n),Q(`Snip created`);return}if(e.data||e.message){let t=typeof e.data==`string`?e.data:e.message||``;t&&(h.lastAgentResponse=t,Q(`Response received`))}},window.addEventListener(`scrollUp`,()=>{let e=v(`.scroll-area`);e&&(e.scrollTop-=60)}),window.addEventListener(`scrollDown`,()=>{let e=v(`.scroll-area`);e&&(e.scrollTop+=60)});function P(){let e=v(`#app`);if(e){if(h.cameraActive){F(e);return}switch(h.screen){case`home`:I(e);break;case`folder`:L(e);break;case`folderSettings`:ee(e);break;case`settings`:te(e);break;case`themeSelect`:ne(e);break;case`editModal`:R(e);break;default:I(e)}}}function F(e){h.cameraStream&&setTimeout(()=>{let e=document.querySelector(`#cameraVideo`);e&&!e.srcObject&&(e.srcObject=h.cameraStream,e.play().catch(()=>{}))},10),e.innerHTML=`
    ...
    </div>`,v(`#btnSettings`)?.addEventListener(`click`,()=>{h.screen=`settings`,P()}),v(`#btnAddFolder`)?.addEventListener(`click`,H),v(`#btnAddSnip`)?.addEventListener(`click`,()=>U()),document.querySelectorAll(`.folder-item`).forEach(e=>{e.addEventListener(`click`,()=>W(e.dataset.id)),$(e,()=>K(`folder`,e.dataset.id))}),document.querySelectorAll(`#homeList .snip-item`).forEach(e=>{e.addEventListener(`click`,()=>q(e.dataset.id)),$(e,()=>K(`snip`,e.dataset.id))})}function L(e){let t=h.folders.find(e=>e.id===h.currentFolderId);if(!t){h.screen=`home`,P();return}let n=h.snips.filter(e=>e.folderId===t.id),r=h.images.filter(e=>e.folderId===t.id),i=S(t),a=[...n.map(e=>({kind:`snip`,data:e,sortKey:e.createdAt})),...r.map(e=>({kind:`image`,data:e,sortKey:e.createdAt}))].sort((e,t)=>e.sortKey-t.sortKey);e.innerHTML=`
    <div class="screen">
      <div class="header">
      ...
      <div class="scroll-area" id="folderList">
        ...
        ${a.map((e,t)=>{let n=x(t+1);if(e.kind===`snip`){let t=e.data;return`<div class="list-item snip-item" data-id="${t.id}">
              ...
              <span class="item-text ${t.checked&&i.checkboxesEnabled?`checked-text`:``}">${y(b(t.text,22))}</span>
            </div>`}else{let t=e.data;return`<div class="list-item img-item" data-id="${t.id}">
              <span class="item-icon">📷</span>
              <span class="item-num">${n}</span>
      ...
      ${h.isRecording?`<div class="rec-pill">🎙 Recording…</div>`:``}
      ${h.statusMsg?`<div class="status-pill">`+y(h.statusMsg)+`</div>`:``}
    </div>`,v(`#btnBack`)?.addEventListener(`click`,()=>{h.screen=`home`,h.currentFolderId=null,h.lastAgentResponse=null,P()}),v(`#btnFolderSettings`)?.addEventListener(`click`,()=>{h.screen=`folderSettings`,P()}),v(`#btnAddSnipF`)?.addEventListener(`click`,()=>U(t.id)),v(`#btnSendAll`)?.addEventListener(`click`,()=>J(t.id)),v(`#btnEmail`)?.addEventListener(`click`,()=>re(t.id)),v(`#mpEl`)?.addEventListener(`click`,()=>K(`masterPrompt`,t.id)),v(`#addMP`)?.addEventListener(`click`,()=>K(`masterPrompt`,t.id)),v(`#agentBar`)?.addEventListener(`click`,X),document.querySelectorAll(`#folderList .snip-item`).forEach(e=>{e.addEventListener(`click`,t=>{t.target.closest(`.snip-cb`)||q(e.dataset.id)}),$(e,()=>K(`snip`,e.dataset.id))}),document.querySelectorAll(`.snip-cb input`).forEach(e=>{e.addEventListener(`change`,async t=>{t.stopPropagation();let n=e.closest(`.snip-cb`).dataset.sid,r=h.snips.find(e=>e.id===n);r&&(r.checked=e.checked,await o(`snips`,r),P())})}),document.querySelectorAll(`#folderList .img-item`).forEach(e=>{e.addEventListener(`click`,()=>Z(e.dataset.id)),$(e,()=>oe(e.dataset.id))})}function ee(e){let t=h.folders.find(e=>e.id===h.currentFolderId);if(!t){h.screen=`home`,P();return}let n=S(t);e.innerHTML=`
    <div class="screen">
      <div class="header">
    ...
    </div>`,v(`#btnBackFS`)?.addEventListener(`click`,()=>{h.screen=`folder`,P()}),v(`#btnDelFolder`)?.addEventListener(`click`,()=>G(t.id));let r=(e,n)=>{let r=v(`#${e}`);r&&r.addEventListener(`change`,async()=>{t.agentSettings||={...l},t.agentSettings[n]=r.checked,await o(`folders`,t)})};r(`togCB`,`checkboxesEnabled`),r(`togLLM`,`useLLM`),r(`togSerp`,`useSerpAPI`),r(`togR1`,`wantsR1Response`),r(`togJournal`,`wantsJournalEntry`)}function te(e){let t=h.settings,n=t.textScale||100;e.innerHTML=`
    <div class="screen">
      <div class="header">
    ...
    </div>`;let i=v(`#editText`);i&&(i.focus(),g=i,i.addEventListener(`focus`,()=>{g=i}),i.addEventListener(`blur`,()=>{setTimeout(()=>{g===i&&(g=null)},200)})),v(`#btnCancelEdit`)?.addEventListener(`click`,z),v(`#btnSaveEdit`)?.addEventListener(`click`,()=>{let e=h.editTarget;e&&e.type===`imageCaption`?se():B()}),v(`#btnDelSnip`)?.addEventListener(`click`,V),v(`#btnDelCaption`)?.addEventListener(`click`,async()=>{let e=h.editTarget;if(!e||e.type!==`imageCaption`)return;let t=h.images.find(t=>t.id===e.id);t&&(t.caption=``,await o(`images`,t)),g=null,z()})}function z(){let e=h.editTarget;g=null,h.editTarget=null,h.screen=e&&(e.type===`masterPrompt`||e.type===`newSnip`)&&h.currentFolderId||h.currentFolderId?`folder`:`home`,P()}async function B(){let e=h.editTarget;if(!e)return;let t=(v(`#editText`)?.value||``).trim();if(e.type===`snip`){let n=h.snips.find(t=>t.id===e.id);n&&(n.text=t,n.updatedAt=Date.now(),await o(`snips`,n))}else if(e.type===`imageCaption`){let n=h.images.find(t=>t.id===e.id);n&&(n.caption=t,n.name=t||n.name,await o(`images`,n))}else if(e.type===`folder`){let n=h.folders.find(t=>t.id===e.id);n&&t&&(n.name=t,await o(`folders`,n))}else if(e.type===`masterPrompt`){let n=h.folders.find(t=>t.id===e.id);n&&(n.masterPrompt=t,await o(`folders`,n))}else if(e.type===`newSnip`&&t){let n={id:_(),text:t,folderId:e.folderId||null,checked:!1,createdAt:Date.now(),updatedAt:Date.now()};h.snips.push(n),await o(`snips`,n)}g=null,z()}async function V(){let e=h.editTarget;!e||e.type!==`snip`||(h.snips=h.snips.filter(t=>t.id!==e.id),await s(`snips`,e.id),g=null,z())}async function H(){let e={id:_(),name:`New Folder`,masterPrompt:``,agentSettings:{...l},createdAt:Date.now()};h.folders.push(e),await o(`folders`,e),K(`folder`,e.id)}function U(e){h.editTarget={type:`newSnip`,folderId:e||h.currentFolderId||null},h.screen=`editModal`,P()}function W(e){h.currentFolderId=e,h.lastAgentResponse=null,h.screen=`folder`,P()}async function G(e){for(let t of h.snips.filter(t=>t.folderId===e))await s(`snips`,t.id);for(let t of h.images.filter(t=>t.folderId===e))await s(`images`,t.id);h.snips=h.snips.filter(t=>t.folderId!==e),h.images=h.images.filter(t=>t.folderId!==e),h.folders=h.folders.filter(t=>t.id!==e),await s(`folders`,e),h.screen=`home`,h.currentFolderId=null,P()}function K(e,t){h.editTarget={type:e,id:t},h.screen=`editModal`,P()}function q(e){let t=h.snips.find(t=>t.id===e);if(!t)return;let n=t.text;if(t.folderId){let e=h.folders.find(e=>e.id===t.folderId);e&&e.masterPrompt&&(n=e.masterPrompt+`

`+t.text)}Y(n)}function J(e){let t=h.folders.find(t=>t.id===e);if(!t)return;let n=h.snips.filter(t=>t.folderId===e),r=h.images.filter(t=>t.folderId===e);if(!n.length&&!r.length){Q(`No snips to send`);return}let i=n.map((e,t)=>x(t+1)+`. `+e.text).join(`

`),a=r.map((e,t)=>{let r=e.caption?` [Caption: ${e.caption}]`:``;return`[Image ${x(n.length+t+1)}: ${e.dataUrl}]${r}`}).join(`

`);Y(t.masterPrompt?t.masterPrompt+`

`+i+(a?`

`+a:``):i+(a?`

`+a:``))}function Y(e){let t=C();typeof PluginMessageHandler<`u`?(PluginMessageHandler.postMessage(JSON.stringify({message:e,useLLM:t.useLLM,useSerpAPI:t.useSerpAPI,wantsR1Response:t.wantsR1Response,wantsJournalEntry:t.wantsJournalEntry})),Q(`Sent to Rabbit`)):Q(`Agent unavailable`)}async function X(){if(!h.lastAgentResponse)return;let e={id:_(),text:h.lastAgentResponse,folderId:h.currentFolderId||null,checked:!1,createdAt:Date.now(),updatedAt:Date.now()};h.snips.push(e),await o(`snips`,e),h.lastAgentResponse=null,Q(`Response saved`)}function re(e){let t=h.folders.find(t=>t.id===e);if(!t)return;let n=h.snips.filter(t=>t.folderId===e),r=h.images.filter(t=>t.folderId===e);if(!n.length&&!r.length){Q(`Folder is empty`);return}let i=``;t.masterPrompt&&(i+=`Master Prompt:
`+t.masterPrompt+`
...
`+i,useLLM:!0,wantsR1Response:a.wantsR1Response};PluginMessageHandler.postMessage(JSON.stringify(e)),Q(`Emailing folder…`)}else Q(`Agent unavailable`)}function Z(e){let t=h.images.find(t=>t.id===e);if(!t)return;let n=document.createElement(`div`);n.className=`img-overlay`;let r=1,i=1,a=0,o=0,s=null,c=document.createElement(`img`);c.src=t.dataUrl,c.className=`img-preview`,c.style.transform=`translate(0,0) scale(1)`,c.style.cursor=`grab`,c.style.transition=`transform 0.1s ease-out`;let l=document.createElement(`div`);l.className=`img-caption`,l.textContent=t.caption||``;let u=document.createElement(`div`);u.className=`img-btn-bar`;let d=document.createElement(`button`);d.className=`img-action-btn`,d.textContent=`Desc`,d.addEventListener(`click`,e=>{e.stopPropagation(),ae(t,l,d)});let f=document.createElement(`button`);f.className=`img-action-btn`,f.textContent=t.caption?`📤 Send to Rabbit`:`📤 Send Image`,f.addEventListener(`click`,e=>{e.stopPropagation(),ie(t)});let p=document.createElement(`button`);p.className=`img-action-btn img-close-btn`,p.textContent=`✕`,p.addEventListener(`click`,()=>n.remove()),u.appendChild(d),u.appendChild(f),u.appendChild(p),n.appendChild(c),t.caption&&n.appendChild(l),n.appendChild(u),document.body.appendChild(n),n.addEventListener(`touchstart`,e=>{if(e.touches.length===2){let t=e.touches[0].clientX-e.touches[1].clientX,n=e.touches[0].clientY-e.touches[1].clientY;s={dist:Math.hypot(t,n),scale:r}}else e.touches.length===1&&(c.style.transition=`none`)},{passive:!0}),n.addEventListener(`touchmove`,e=>{if(e.touches.length===2&&s){let t=e.touches[0].clientX-e.touches[1].clientX,n=e.touches[0].clientY-e.touches[1].clientY;r=Math.max(1,Math.min(i*(Math.hypot(t,n)/s.dist),5)),c.style.transform=`translate(${a}px,${o}px) scale(${r})`,c.style.cursor=`grab`}else e.touches.length===1&&r>1&&(a+=e.touches[0].movementX,o+=e.touches[0].movementY,c.style.transform=`translate(${a}px,${o}px) scale(${r})`)},{passive:!0}),n.addEventListener(`touchend`,e=>{e.touches.length<2&&(s=null,i=r,c.style.transition=`transform 0.2s ease-out`,r<=1&&(r=1,i=1,a=0,o=0)),e.touches.length===0&&(c.style.transition=`transform 0.2s ease-out`)}),c.addEventListener(`wheel`,e=>{e.preventDefault();let t=e.deltaY>0?.9:1.1;r=Math.max(1,Math.min(r*t,5)),i=r,c.style.transform=`translate(${a}px,${o}px) scale(${r})`},{passive:!1}),c.addEventListener(`click`,e=>{r>1?(r=1,i=1,a=0,o=0,c.style.transform=`translate(0,0) scale(1)`):n.remove()})}function ie(e){let t=C(),n=e.caption||``;typeof PluginMessageHandler<`u`?(PluginMessageHandler.postMessage(JSON.stringify({message:n||`Here is a photo.`,pluginId:`com.r1.pixelart`,imageBase64:e.dataUrl,useLLM:!0,wantsR1Response:t.wantsR1Response,wantsJournalEntry:t.wantsJournalEntry})),Q(`Sending to Rabbit…`)):Q(`Agent unavailable`)}async function ae(e,t,n){if(n.textContent=`…`,n.disabled=!0,typeof PluginMessageHandler<`u`){PluginMessageHandler.postMessage(JSON.stringify({message:`describe what you see in this image in full detail including any recognizable text`,pluginId:`com.r1.pixelart`,imageBase64:e.dataUrl,useLLM:!0,wantsR1Response:!1,wantsJournalEntry:!1}));let r=window.onPluginMessage;window.onPluginMessage=async function(i){window.onPluginMessage=r;let a=i.data||i.message||``;a&&typeof a==`string`&&(e.caption=a.trim(),e.name=e.caption,await o(`images`,e),t.textContent=e.caption,t.style.color=`var(--accent)`,setTimeout(()=>{t.style.color=``},2e3),Q(`Caption saved`)),n.textContent=`Desc`,n.disabled=!1}}else n.textContent=`Desc`,n.disabled=!1,Q(`Agent unavailable`)}function oe(e){h.images.find(t=>t.id===e)&&(h.editTarget={type:`imageCaption`,id:e},h.screen=`editModal`,P())}async function se(){let e=h.editTarget;if(!e||e.type!==`imageCaption`)return;let t=h.images.find(t=>t.id===e.id);if(!t)return;let n=(v(`#editText`)?.value||``).trim();t.caption=n,t.name=n||`Photo `+new Date().toLocaleTimeString(),await o(`images`,t),g=null,z()}function Q(e){h.statusMsg=e,P(),setTimeout(()=>{h.statusMsg=``,P()},2e3)}function $(e,t,n){if(!e)return;n||=600;let r=null,i=!1,a=()=>{i=!1,r=setTimeout(()=>{i=!0,t()},n)},o=e=>{clearTimeout(r),i&&(e.preventDefault(),e.stopPropagation())};e.addEventListener(`touchstart`,a,{passive:!0}),e.addEventListener(`touchend`,o),e.addEventListener(`touchcancel`,o),e.addEventListener(`mousedown`,a),e.addEventListener(`mouseup`,o),e.addEventListener(`mouseleave`,o)}async function ce(){h.settings=await u(),h.folders=await a(`folders`),h.snips=await a(`snips`),h.images=await a(`images`),p(h.settings.theme),m(h.settings.textScale||100),P()}document.addEventListener(`DOMContentLoaded`,ce);